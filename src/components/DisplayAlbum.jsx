...
import { albumsData, assetIcon, songsData } from "../assets";
...
<h4>{albumData.comments}</h4>
<p className="mt-1">
<img className="inline-block w-5" src={assetIcon.logo} alt="icon"/>
<b>Sand</b>
* 1,323,154 likes
* <b>50 songs,</b>
about 2 hr 30 min
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 mt-10 mb-4 pl-2 text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer">
        <p><b className="mr-4">#</b>Title</p>
        <p>Album</p>
        <p className="hidden sm:block">Date Added</p>
<img className="m-auto w-4" src={assetIcon.clock} alt="clock icon"/>
      </div>
      <hr/>
